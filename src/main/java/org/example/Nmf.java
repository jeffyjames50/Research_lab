...
public class Nmf {
    ...
    public Map<String, Double> nmfAgeGroup(String trainFile1, String trainFile18, String trainFile25, String trainFile35, String trainFile45, String trainFile50, String trainFile56, Map<String, Double> maeByAgeGroup, String testFile, DataModel datamodel) throws IOException {
    ...
    private static Double findAverageMAE(String trainFile,String testFile, DataModel datamodel,Integer agegroup) throws IOException {
        ...
        NMF nmf = new NMF(datamodel1,2,50);
        nmf.fit();
