...
public class BnMf {
    ...
    public Map<String, Double> bnmfAgeGroup(String trainFile1, String trainFile18, String trainFile25, String trainFile35, String trainFile45, String trainFile50, String trainFile56, Map<String, Double> maeByAgeGroup, String testFile, DataModel datamodel) throws IOException {
    ...
    private static Double findAverageMAE(String trainFile,String testFile, DataModel datamodel,Integer agegroup) throws IOException {
        ...
        BNMF bnMf = new BNMF(datamodel1,10,100,0.6,5);
        bnMf.fit();
